...
class SpringAiDeepSeekChatPortTest {

    @Test
    void shouldCallChatClientWithMessage() {
        RecordingChatModel chatModel = new RecordingChatModel();
        SpringAiDeepSeekChatPort deepSeekChatPort =
                new SpringAiDeepSeekChatPort(ChatClient.create(chatModel));

        String answer = deepSeekChatPort.chat("你好");
