...
class KnowledgeSearchServiceTest {
    ...
    void shouldRerankPgVectorCandidates() {
        ...
        RecordingKnowledgeDao repository =
                new RecordingKnowledgeDao(List.of(first, second));
        RecordingReranker reranker = new RecordingReranker(List.of(
    ...
    void shouldFallBackToPgVectorResultsWhenRerankingFails() {
        ...
        RecordingKnowledgeDao repository =
                new RecordingKnowledgeDao(candidates);
    ...
    private static final class RecordingKnowledgeDao implements KnowledgeDao {
        ...
        private RecordingKnowledgeDao(List<SearchHit> hits) {
            this.hits = hits;
        }
